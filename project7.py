...
Original file is located at
    https://colab.research.google.com/drive/16YKZlVWSSTcUM19KCxT3hMGBzN3pmCTq
"""
...
y_test_nb = nb.predict(X_test)#computing the accuracy, f1_score, Recall, precision of the model performance
